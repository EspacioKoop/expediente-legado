...
; Carrera arcade pulp de cocodrilos moteros entre El Cairo y Giza.
; Codigo y pixel-art originales del proyecto, licencia MIT.
; Sin guardado ni recompensas fuera de la ROM.
...
DEF TILE_ROAD       EQU 1
DEF TILE_EDGE       EQU 2
DEF TILE_PYR_L      EQU 3
DEF TILE_PYR_M      EQU 4
DEF TILE_PYR_R      EQU 5
DEF TILE_SPHINX_H   EQU 6
DEF TILE_SPHINX_B   EQU 7
DEF TILE_WAVE       EQU 8
DEF TILE_TOWER      EQU 9
DEF TILE_FINISH     EQU 10
DEF DIGIT_BASE      EQU 11
DEF TILE_C          EQU 21
DEF TILE_R          EQU 22
DEF TILE_O          EQU 23
DEF TILE_I          EQU 24
...
DEF TILE_E          EQU 26
DEF TILE_S          EQU 27
DEF TILE_ARROW      EQU 28
DEF TILE_CROC_TL    EQU 29
DEF TILE_CROC_TR    EQU 30
DEF TILE_CROC_BL    EQU 31
DEF TILE_CROC_BR    EQU 32
DEF TILE_TAXI_TOP   EQU 33
DEF TILE_TAXI_BOTTOM EQU 34
DEF TILE_STRIPE     EQU 35
DEF TILE_SCALE      EQU 36
DEF TILE_NITRO      EQU 37
DEF TILE_TROPHY     EQU 38
DEF TILE_CRASH      EQU 39
DEF TILE_FLAME      EQU 40
...
AvanzarCarrera:
    ; Sin turbo, el mundo avanza a 30 Hz; con turbo, a 60 Hz.
    ld a, [wTurbo]
    or a
    jr nz, .mover
    ld a, [wFrame]
...
Tiles:
    ...
    rept 8
        db $FF, $00
    endr
    ; 2: borde de carretera
    rept 8
        db $81, $81
    endr
    ; 3-5: piramide izquierda/centro/derecha
    ...
    ; 29-32: cocodrilo motero 16x16
    db $18,$00,$3C,$00,$7E,$00,$FE,$00,$FC,$00,$7C,$00,$38,$00,$18,$00
    db $00,$00,$00,$00,$C0,$00,$F0,$00,$FC,$00,$7E,$00,$0C,$00,$00,$00
    db $18,$18,$3C,$24,$7E,$42,$5A,$42,$18,$18,$24,$24,$42,$42,$3C,$3C
    db $18,$18,$3C,$24,$7E,$42,$5A,$42,$18,$18,$24,$24,$42,$42,$3C,$3C
    ; 33-34: taxi/obstaculo
    db $3C,$00,$7E,$00,$FF,$00,$C3,$00,$FF,$00,$FF,$00,$DB,$DB,$81,$81
    db $81,$81,$DB,$DB,$FF,$00,$FF,$00,$C3,$00,$FF,$00,$7E,$00,$3C,$00
    ; 35: marca de carril
...
PaletasObjetos:
    ...
    dw $7FFF, $02A0, $029F, $0000
    ; 2 trafico, marcas y turbo: amarillo / azul / negro
