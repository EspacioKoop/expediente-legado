...
Antes de la primera pasada hay que compilar la GDExtension GB/GBC y las ROMs propias, o las pruebas que arrancan Godot se saltan indicándolo. Una sola orden lo deja todo listo, y es idempotente: lo ya compilado no se repite.
