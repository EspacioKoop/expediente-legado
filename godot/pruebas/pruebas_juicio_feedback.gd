...
static func todo(comprobar: Callable) -> void:
	...
	comprobar.call("feedback: material conserva rugosidad", base.roughness, 0.9)
	...
	comprobar.call("feedback: emisión conserva energía", emisivo.emission_energy_multiplier, 0.8)
