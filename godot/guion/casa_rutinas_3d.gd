...
static func _montar_persiana(
	...
	(
		...
		. configurar(
			...
			{
				"pos": Vector3(0, 0.0, 0.10),
				"rot": Vector3.ZERO,
				"texto": "Abrir persiana",
				"sonido": "abrir",
			...
			},
			{
				...
				"sonido": "cerrar",
				"verbo": Interactuable3D.Verbo.CERRAR,
			},
...
static func _montar_platos(
	...
	(
		...
		. configurar(
			...
			{
				"pos": Vector3(0, 0.12, 0.05),
				"rot": Vector3.ZERO,
				"texto": "Fregar y recoger platos",
				"sonido": "coger",
				"verbo": Interactuable3D.Verbo.USAR,
			},
			{
				"pos": Vector3(0, 0.18, -0.52),
				"rot": Vector3.ZERO,
				"texto": "Sacar platos",
				"sonido": "coger",
				"verbo": Interactuable3D.Verbo.USAR,
...
static func _montar_toalla(
	...
	(
		...
		. configurar(
			...
			{
				"pos": pos_ventana,
				"rot": Vector3(0, 0, 90.0),
				"texto": "Recoger toalla",
				"sonido": "coger",
