...
## Una contribución muy baja, solo de la textura, evita que la trama desaparezca
## en sombra sin convertir la sala en una escena iluminada.
const REALCE_TEXTURA_ONIRICO := 0.08
...
const FORMAS := {
	...
	"crucero":
	{
		...
		"realce_textura": REALCE_TEXTURA_ONIRICO,
