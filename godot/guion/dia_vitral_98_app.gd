## Wiring runtime de VITRAL 98 (#932).
##
## Mantiene su registro de exposición en el controller de Dia y observa la
## Portátil Color 98 sin modificar la ROM ni la consola.
extends Node

var _registro: Dictionary = ReligionEventos.nuevo()
var _mundo_id := 0
var _observador: Vitral98Vigilia = null
...
func _montar_observador(mundo: Node3D, jornada: Dictionary) -> void:
	var existente := mundo.get_node_or_null("Vitral98VigiliaCasa") as Vitral98Vigilia
	if existente != null:
	...
	if consola == null:
		return
	_observador = Vitral98Vigilia.new()
	_observador.name = "Vitral98VigiliaCasa"
