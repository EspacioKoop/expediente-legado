...
class AquilesRomRuntimeTest(unittest.TestCase):
    ...
    def test_observer_exige_rom_y_estado_de_victoria(self):
        ...
        self.assertIn(
            "_consola.leer_memoria_rom_u8(DIRECCION_ESTADO) != ESTADO_VICTORIA",
            self.vigilia,
        )

    def test_observer_registra_semilla_con_fuente_de_rom(self):
    ...
    def test_observer_sigue_activo_con_arbol_pausado(self):
