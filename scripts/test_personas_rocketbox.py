...
PERFIL_JUGADOR = ROOT / "godot" / "guion" / "perfil_jugador.gd"
...
class PersonasRocketboxTest(unittest.TestCase):
    def test_cada_companero_apunta_a_un_avatar_versionado(self):
        # Compañeros de oficina y cuerpos elegibles del protagonista: entre
        # los dos usan todos los avatares del repositorio y ninguno sobra.
        texto = COMPANEROS.read_text(encoding="utf-8") + PERFIL_JUGADOR.read_text(encoding="utf-8")
